const setup = () => {
    const resultaatButton = document.getElementById("resultaatButton");
    resultaatButton.addEventListener("click", toonResultaat);
};
...
const toonResultaat = () => {
    ...
    const moedertaalInput = document.getElementsByName("moedertaal");
    let moedertaal;
    for (const input of moedertaalInput) {
        if (input.checked) {
